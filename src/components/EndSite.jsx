...
<div className='sm:w-60 '>
    <div className='p-2'>
       ...
       <p className='SubNavText hover:font-semibold hover:underline flex items-start mt-2'>About Daraz</p>
        ...
        <p className='SubNavText  hover:font-semibold hover:underline mt-0.5 flex items-start'>Digital Payments</p>
        <p className='SubNavText  hover:font-semibold hover:underline mt-0.5 flex items-start'>Digital Payments</p>
        <p className='SubNavText  hover:font-semibold hover:underline mt-0.5 flex items-start'>Daraz Card</p>
        <p className='SubNavText  hover:font-semibold hover:underline mt-0.5 flex items-start'>Daraz Blog</p>
        <p className='SubNavText  hover:font-semibold hover:underline mt-0.5 flex items-start'>Daraz Cares</p>
        <p className='SubNavText  hover:font-semibold hover:underline mt-0.5 flex items-start'>Daraz Mart</p>
        <p className='SubNavText  hover:font-semibold hover:underline mt-0.5 flex items-start'>Privacy Policy</p>
        <p className='SubNavText  hover:font-semibold hover:underline mt-0.5 flex items-start'>Daraz App</p>
...
<div className='sm:w-60 pt-2'>
    <div className=''>
     ...
     <div className='flex items-start gap-5 mt-3 cursor-pointer'>
        ...
        <span className='flex items-center justify-center gap-1'>
           <img className='h-6 w-6 rounded-full' src="./src/assets/Bangladesh.webp" alt="hello" />
     ...
     <div className='flex cursor-pointer items-start gap-4 mt-2'>
        ...
        <span className='flex items-center justify-center gap-1'>
            ...
            <img className='h-6 w-6 rounded-full' src="./src/assets/myanmar.png" alt="hello" />
...
<img className='h-7 w-12' src="./src/assets/duchbangla.jpeg" alt="hello" />
