...
<h1>Categories</h1>
<h1 className='mt-1 hover:rotate-180 hover:'><FaAngleDown/></h1>
</span>
<span className='flex items-center '>
  <input className='relative  md:ms-10 text-black sm:w-96 flex p-1.5 rounded-md' placeholder='Search in Daraz' type="text" />
