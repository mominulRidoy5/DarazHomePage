...
<span className='flex items-center justify-around gap-1 hover:bg-stone-600 hover:rounded-md sm:hover:p-1'>
...
<span className='flex items-center  justify-center gap-1  hover:bg-stone-600  hover:rounded-md sm:hover:p-1'>
  <a><FaGlobe /></a>
  <h1>EN</h1>
  <a className='mt-1 '><FaAngleDown /></a>
</span>

<a className='text-3xl flex items-center justify-center  hover:bg-stone-600 hover:rounded-md sm:hover:p-1' href=""> < CiShoppingCart/></a>
